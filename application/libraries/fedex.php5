...
function getProperty($var){
  ...
  if($var == 'key') Return 'XXX'; 
	...
	if($var == 'spodshipdate') Return '2017-08-04';
	if($var == 'serviceshipdate') Return '2017-08-04';
  if($var == 'shipdate') Return '2017-08-03';
	...
	if($var == 'shipper') Return array(
		'Contact' => array(
			'PersonName' => 'Mayur',
			'CompanyName' => 'Rebelute',
			'PhoneNumber' => '8983582663'
		),
		'Address' => array(
			'StreetLines' => array('Addres \r  RB-2 F-10 Tadiwala Road'),
			'City' => 'Pune',
