...
class Ajax_pagination {
    ...
    var $cur_tag_open = '<li class="current"><a href="#" class="page-numbers ">';
    ...
    function create_links() {
        ...
        if ($num_pages == 1) {
            $info = '<span class="text-danger ">Showing : ' . $this->total_rows.'</span>';
            $info = '';
            return $info;
        }
        ...
        if ($this->cur_page != 1) {
            ...
            $output .= $this->prev_tag_open
                    . $this->getAJAXlink($i, $this->prev_link, 'first')
                    . $this->prev_tag_close;
        }
        ...
        if ($this->cur_page < $num_pages) {
            $output .= $this->next_tag_open
                    . $this->getAJAXlink($this->cur_page * $this->per_page, $this->next_link, 'last')
                    . $this->next_tag_close;
        }
    ...
    function getAJAXlink($count, $text, $link = null) {
        $pageCount = $count ? $count : 0;
        if ($link == 'last')
            return '<a class="last page-numbers fa fa-angle-double-right" href="javascript:void(0);"' . $this->anchor_class . ' onclick="' . $this->link_func . '(' . $pageCount . ')">' . $text . '</a>';
        else if ($link == 'first')
            return '<a class="first page-numbers fa fa-angle-double-left" href="javascript:void(0);"' . $this->anchor_class . ' onclick="' . $this->link_func . '(' . $pageCount . ')">' . $text . '</a>';
        else
            return '<a class="page-numbers" href="javascript:void(0);"' . $this->anchor_class . ' onclick="' . $this->link_func . '(' . $pageCount . ')">' . $text . '</a>';
    }
