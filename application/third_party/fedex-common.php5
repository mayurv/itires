...
function getProperty($var){
  ...
  if($var == 'key') Return 'NPzAj6lpCc5ijmJb'; 
	if($var == 'password') Return 'VncSFihsSPlnaAYg9rWZa5suU';
	if($var == 'parentkey') Return 'NPzAj6lpCc5ijmJb'; 
	if($var == 'parentpassword') Return 'VncSFihsSPlnaAYg9rWZa5suU'; 		
	...
	if($var == 'meter') Return '100345337';
		
	if($var == 'shiptimestamp') Return mktime(10, 0, 0, date("m"), date("d")+1, date("Y"));

	if($var == 'spodshipdate') Return '2017-04-13';
	if($var == 'serviceshipdate') Return '2017-04-26';
  if($var == 'shipdate') Return '2017-04-21';

	if($var == 'readydate') Return '2017-12-15T08:44:07';
	//if($var == 'closedate') Return date("Y-m-d");
	if($var == 'closedate') Return '2017-04-18';
	...
	if($var == 'begindate') Return '2017-10-16';
	if($var == 'enddate') Return '2017-10-16';	

	if($var == 'trackingnumber') Return '1957380121';
