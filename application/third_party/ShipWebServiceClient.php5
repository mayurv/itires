<?php
//$product_data = $this->flexi_cart->cart_items();
...
$path_to_wsdl = "wsdl/ShipService_v21.wsdl";
...
$request['RequestedShipment'] = array(
    ...
    'Shipper' => getProperty('shipperbilling'),
...
try {
    ...
    echo $response->CompletedShipmentDetail->MasterTrackingId->TrackingNumber;
