<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Section</h2>
                    <button id="btn_toggl_vw" type="button" class="btn btn-default pull-right btn-sm"><i class="fa fa-plus-circle" ></i> Add Page</button>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <br />
                            ...
                            foreach ($section as $slide) {
                                ...
                                <tbody>
                                    ...
                                    <tr id="attr_">
                                            <!--<td>1</td>-->
                                        <td><?= $count++ ?></td>
                                        <td><?= $slide['page_alias'] ?></td>

                                        <td >
                                            <?= $slide['status'] ?>
                                        </td>
                                        <td>
                                            <a href="<?= base_url() ?>admin/section/edit_section/<?= $slide['cms_id'] ?>" class="btn btn-round btn-xs btn-default" ><i class="fa fa-pencil"></i></a>
    <!--                                            <button class="btn btn-round btn-xs btn-danger" data-toggle="modal" onclick="deleteAttribute(<?php echo $slide['cms_id']; ?>)"><i class="fa fa-trash"></i></button>-->
                    ...
                    <div id="id_add_attribute_form" hidden="">
                        <form action="<?php echo base_url(); ?>admin/section/add_page_section/add" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
