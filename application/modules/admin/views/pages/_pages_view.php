                            ...
                            foreach ($pages as $slide) {
                                ...
                                <tbody>
                                    ...
                                    <tr id="attr_">
                                        ...
                                        <td>
                                            <a href="<?= base_url() ?>admin/pages/page/<?= $slide['id'] ?>" class="btn btn-round btn-xs btn-default" ><i class="fa fa-pencil"></i></a>
    <!--                                            <button class="btn btn-round btn-xs btn-danger" data-toggle="modal" onclick="deleteAttribute(<?php echo $slide['cms_id']; ?>)"><i class="fa fa-trash"></i></button>-->
                                        </td>
                                    </tr>
                    ...
                    <div id="id_add_attribute_form" hidden="">
                        <form action="<?php echo base_url(); ?>admin/pages/add_page/add" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">

                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Title<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="title" id="attribute_value" required="required" class="form-control col-md-7 col-xs-12" placeholder="Title">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="mtitle" id="attribute_value" required="required" class="form-control col-md-7 col-xs-12" placeholder="Title">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="link" id="attribute_value" required="required" class="form-control col-md-7 col-xs-12" placeholder="Title">
                                </div>
                            </div>
                            <div class="form-group">
