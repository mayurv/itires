...
<div class="shoppingCartWrap pt-40 mb-40">
    ...
    <!--<p><a href="<?php // echo $base_url;                  ?>admin_library/orders">Manage Orders</a></p>-->
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="top-link">
                    <a href="<?php echo base_url(); ?>admin_library/invoice/<?php echo $summary_data[$this->flexi_cart_admin->db_column('order_summary', 'order_number')]; ?>" class=" print hidden-print"><i class="fa fa-download"></i></a>
                    <a onclick="window.print();" class="print"><i class="fa fa-print hidden-print"></i></a>
                </div>
