...
<div class="shoppingCartWrap pt-40 mb-40">
    ...
    <!--<p><a href="<?php // echo $base_url;          ?>admin_library/orders">Manage Orders</a></p>-->
        <div class="row">
            ...
            <?php } ?>
            <a href="<?php echo base_url(); ?>home/orders" class="pre-page">Back to Previous Page</a>
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-12">
                        <fieldset>
                    ...
                    <!--                                <td class="align_ctr">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><?php echo $this->flexi_cart_admin->format_currency($summary_data[$this->flexi_cart_admin->db_column('order_summary', 'item_summary_total')], TRUE, 2, TRUE); ?></td>
                                    </tr>
                                </tfoot>
                            </table>
                            <hr>
...
<!--            <ul class="<?php echo ($summary_data[$this->flexi_cart_admin->db_column('order_status', 'cancelled')] == 1) ? 'order_status_cancelled' : 'order_status_active'; ?>">
        ...
        <div class="main-invoice_section">
            <div class="custom_header1">
                ...
                <address >
                    <h1>Name: Admin istrator</h1>
                    <p>Address 01: RB-2, F-10, tadiwal Road</p>
                    <p>Address 02:</p>
                    <p>City / Town: Pune</p>
                    <p>State / County: 1</p>
                    <p>Post / Zip Code: 411001</p>
                    <p>Country: 1</p>
                </address>
                <span>
                    <img alt="" src="http://ittires.dev.rebelutedigital.com/media/backend/img/logo/logo.png">
            ...
            <article>
                ...
                <table class="meta">
                    <tr>
                        ...
                        <td><span >00000002</span></td>
                    </tr>
                    <tr>
                        <th><span >Order Date</span></th>
                        <td><span > 1st Aug 2017</span></td>
                    </tr>
                    <tr>
                ...
                <table class="balance">
                    <tr>
                        ...
                        <td><span data-prefix>US $</span><span> 2,338.16</span></td>
                    </tr>
                    <tr>
            ...
            <aside>
                ...
                <div class="col-sm-6">
                    <fieldset class="w50 r_margin">
                        <legend>Billing Details</legend>
                        <ul>
                            <li><span class="spacer_125">Name: </span>Admin istrator</li>
                            <li><span class="spacer_125">Address 01: </span>RB-2, F-10, tadiwal Road</li>
                            <li><span class="spacer_125">Address 02: </span></li>
                            <li><span class="spacer_125">City / Town: </span>Pune</li>
                            <li><span class="spacer_125">State / County: </span>1</li>
                            <li><span class="spacer_125">Post / Zip Code: </span>411001</li>
                            <li><span class="spacer_125">Country: </span>1</li>
                        </ul>
                    </fieldset>
                ...
                <div class="col-sm-6">
                    <div class="parallel">
                        <fieldset class="w50 parallel_target">
                            <legend>Contact Details</legend>
                            <ul>
                                <li><span class="spacer_125">Email: </span>admin@admin.com</li>
                                <li><span class="spacer_125">Phone: </span>8983582663</li>
                            </ul>               
                        </fieldset>
