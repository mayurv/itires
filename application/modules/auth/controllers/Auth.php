    ...
    public function register_user() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $additional_data = array(
                ...
                'profileimg' => 'media/default-user.png',
            ...
            if (isset($_FILES['profile_image']['name']) && $_FILES['profile_image']['name'] != '') {
                ...
                $additional_data['type'] = $fileExt['extension'];


                $uploded_file_path = $this->handleUploadUser($slug);
                if ($uploded_file_path != '')
                    $additional_data['profileimg'] = $targetDir . $uploded_file_path;
            }
...
//        $this->_render_page('auth/edit_user', $this->data);
    ...
    public function delete_user($id) {
        if ($this->users->delete_user_data($id)) {
            redirect('auth');
        }
    }
