...
//			$row = $this->input->post('update');
        ...
        $sql_update = array(
            $this->flexi_cart_admin->db_column('discounts', 'type') =>$this->input->post('coupon_type'),
            $this->flexi_cart_admin->db_column('discounts', 'method') => 13, // $this->input->post('coupon_method'),
            $this->flexi_cart_admin->db_column('discounts', 'tax_method') => 1, //$this->input->post('tax_method'),
            //$this->flexi_cart_admin->db_column('discounts', 'location') => $row['location'],
            //$this->flexi_cart_admin->db_column('discounts', 'zone') => $row['zone'],
            $this->flexi_cart_admin->db_column('discounts', 'group') => 0, //$this->input->post('zone'),
            $this->flexi_cart_admin->db_column('discounts', 'item') => 0, //$test,
            $this->flexi_cart_admin->db_column('discounts', 'code') => $this->input->post('coupon_code'),
            $this->flexi_cart_admin->db_column('discounts', 'description') => $this->input->post('coupon_desc'),
            $this->flexi_cart_admin->db_column('discounts', 'quantity_required') => $this->input->post('quantity'),
            $this->flexi_cart_admin->db_column('discounts', 'quantity_discounted') =>$this->input->post('coupon_quantity'),
            $this->flexi_cart_admin->db_column('discounts', 'value_required') => $this->input->post('coupon_quantity_a'), //$this->input->post('coupon_value'),
            $this->flexi_cart_admin->db_column('discounts', 'value_discounted') => $this->input->post('coupon_value'),
...
//				$this->flexi_cart_admin->db_column('discounts', 'void_reward_points') => $row['void_reward'],
            ...
            $this->flexi_cart_admin->db_column('discounts', 'custom_status_1') => '', //$this->input->post('custom_status'),
...
//				$this->flexi_cart_admin->db_column('discounts', 'custom_status_3') => $row['custom_status_3'],
            $this->flexi_cart_admin->db_column('discounts', 'usage_limit') => $this->input->post('uses_limit'),
            $this->flexi_cart_admin->db_column('discounts', 'valid_date') => $this->input->post('from_date'),
            $this->flexi_cart_admin->db_column('discounts', 'expire_date') => $this->input->post('to_date'),
            $this->flexi_cart_admin->db_column('discounts', 'status') => 1, //$this->input->post('isactive'),
        ...
        if ($this->flexi_cart_admin->update_db_discount($sql_update, $discount_id)) {
            ...
            $this->session->set_flashdata('message', $this->flexi_cart_admin->get_messages('admin'));
            redirect('admin_library/item_discounts');
        } else {
            // Set errors.
            $this->session->set_flashdata('message', $this->flexi_cart_admin->get_messages('admin'));
            redirect(current_url());
...
//            {
//               $test=$this->input->post('product')[$i];
//                 // print_r($test);
//                  $sql_insert = array(
//				$this->flexi_cart_admin->db_column('discounts', 'type') => 1,//$this->input->post('coupon_type'),
//				$this->flexi_cart_admin->db_column('discounts', 'method') => 13,// $this->input->post('coupon_method'),
//				$this->flexi_cart_admin->db_column('discounts', 'tax_method') => 1,//$this->input->post('tax_method'),
//				//$this->flexi_cart_admin->db_column('discounts', 'location') => $row['location'],
//				//$this->flexi_cart_admin->db_column('discounts', 'zone') => $row['zone'],
...
//				$this->flexi_cart_admin->db_column('discounts', 'code') => $this->input->post('coupon_code'),
//				$this->flexi_cart_admin->db_column('discounts', 'description') => $this->input->post('coupon_desc'),
//				$this->flexi_cart_admin->db_column('discounts', 'quantity_required') => 0,//$this->input->post('quantity'),
//				$this->flexi_cart_admin->db_column('discounts', 'quantity_discounted') => 0,//$this->input->post('coupon_quantity'),
//				$this->flexi_cart_admin->db_column('discounts', 'value_required') => 10.00,//$this->input->post('coupon_value'),
...
////				$this->flexi_cart_admin->db_column('discounts', 'custom_status_2') => $row['custom_status_2'],
////				$this->flexi_cart_admin->db_column('discounts', 'custom_status_3') => $row['custom_status_3'],
//				$this->flexi_cart_admin->db_column('discounts', 'usage_limit') => 99,//$this->input->post('uses_limit'),
//				$this->flexi_cart_admin->db_column('discounts', 'valid_date') => $this->input->post('from_date'),
//				$this->flexi_cart_admin->db_column('discounts', 'expire_date') => $this->input->post('to_date'),
//				$this->flexi_cart_admin->db_column('discounts', 'status') => 1,//$this->input->post('isactive'),
//				//$this->flexi_cart_admin->db_column('discounts', 'order_by') => $row['order_by']
...
//            {
//                $test=$this->input->post('product')[$k];
//                print_r($test);
//            }
//  
//		$this->load->library('form_validation');
