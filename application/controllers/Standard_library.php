...
redirect('home/cart');
    ...
    function insert_ajax_link_item_to_cart($item_id = 0) {
        ...
        $countItem = count($this->flexi_cart->cart_items());
//        $this->data = '';
        if (isset($_SESSION['flexi_cart']))
            $this->data = $_SESSION['flexi_cart'];
        echo json_encode(array('content' => $this->data));
        die;
...
//        redirect('standard_library/view_cart');
     ...
     * This function is accessed from thclae navigation menu 'Feature Examples'.
     */
