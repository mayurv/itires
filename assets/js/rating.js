...
(function(a){
    a.fn.spaceo_rating_widget = function(p){
        ...
        function init(){
            ...
            for(var i=1;i<=b;i++){
                a.append('<li style="background-image:url('+d+'widget_star.gif);background-repeat-x: no-repeat;float:left;list-style:none;width:14%;height:28px"><span style="color:White; visibility: hidden;">'+i+'</span></li>')
            }
            a.insertAfter(g);
            if(e != ""){
                f = e;
